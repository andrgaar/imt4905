...
class CellRelayRendezvous1(TorCell):
    ...
    def __init__(self, handshake_data, rendezvous_cookie, circuit_id):
        super().__init__(circuit_id)
        assert len(rendezvous_cookie) == 20
        self.rendezvous_cookie = rendezvous_cookie
        self.handshake_data = handshake_data
    ...
    def _serialize_payload(self):
        return self.rendezvous_cookie+self.handshake_data

    @staticmethod
    def _deserialize_payload(payload, proto_version):
        raise NotImplementedError('CellRelayRendezvous1 deserialization not implemented')
