...
class TorCellSocket:
    ...
    def recv_data(self):
        while self._socket:
            logger.debug("Starting data receive")
            more_data = self._socket.recv(2)
            logger.debug(more_data)
